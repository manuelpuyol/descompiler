...
Automata *CreateProgramAutomata(AutomataList *list) {
  ...
  Automata *program_automata = InitAutomata(list, 5, "program");
  Automata *tipos_automata = InitAutomata(list, 5, "tipos");
  Automata *tipo_automata = InitAutomata(list, 2, "tipo");
  Automata *renomear_automata = InitAutomata(list, 5, "renomear");
  Automata *estrutura_automata = InitAutomata(list, 7, "estrutura");
  Automata *nome_automata = identifier_check_automata;
  Automata *numero_automata = number_check_automata;
  Automata *tipo_base_automata = InitAutomata(list, 2, "tipo_base");
  Automata *funcoes_automata = InitAutomata(list, 3, "funcoes");
  Automata *implementacao_automata = InitAutomata(list, 10, "implementacao");
  Automata *tipo_nome_automata = InitAutomata(list, 2, "tipo_nome");
  Automata *dados_automata = InitAutomata(list, 5, "dados");
  Automata *assinaturas_automata = InitAutomata(list, 5, "assinaturas");
  Automata *assinatura_automata = InitAutomata(list, 7, "assinatura");
  Automata *parametro_automata = InitAutomata(list, 3, "parametro");
  Automata *declaracao_automata = InitAutomata(list, 7, "declaracao");
  Automata *comandos_funcao_automata = InitAutomata(list, 3, "comandos_funcao");
  Automata *lista_comandos_automata = InitAutomata(list, 2, "lista_comandos");
  Automata *comando_automata = InitAutomata(list, 2, "comando");
  Automata *atribuicao_automata = InitAutomata(list, 5, "atribuicao");
  Automata *expressao_automata = InitAutomata(list, 2, "expressao");
  Automata *aritmetica_automata = InitAutomata(list, 2, "aritmetica");
  Automata *termo_arita_automata = InitAutomata(list, 2, "termo_arita");
  Automata *fator_arit_automata = InitAutomata(list, 5, "fator_arit");
  Automata *variavel_automata = InitAutomata(list, 6, "variavel");
  Automata *retorno_automata = InitAutomata(list, 4, "retorno");
  Automata *main_automata = InitAutomata(list, 9, "main");
  Automata *chamada_automata = InitAutomata(list, 5, "chamada");
  Automata *lista_argumentos_automata = InitAutomata(list, 2, "lista_argumentos");
  Automata *argumento_automata = InitAutomata(list, 2, "argumento");
  Automata *impressao_automata = InitAutomata(list, 7, "impressao");
